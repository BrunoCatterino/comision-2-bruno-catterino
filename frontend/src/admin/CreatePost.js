...
const validationSchema = yup.object({
    title: yup
        .string('Agregar un título de publicación')
        .min(4, 'El contenido de texto debe tener un mínimo de 4 caracteres')
        .required('Se requiere el título de la publicación'),
    content: yup
        .string('Agregar contenido de texto')
        .min(10, 'El contenido de texto debe tener un mínimo de 10 caracteres ')
        .required('Se requiere contenido de texto'),
});
